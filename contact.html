                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 mb-30">
                            ...
                            <h2 class="title-semibold-dark size-xl">Our Customer Support Representatives Are Ready To Help You 24/7, 365 Days a Year!</h2>
                            <p class="size-lg mb-40">Esimply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            ...
                            <ul class="address-info">
                                <li>
                                    <i class="fa fa-map-marker" aria-hidden="true"></i>29 Street, Melbourne City, Australia # 34 Road, House #10.</li>
                                <li>
                                    <i class="fa fa-phone" aria-hidden="true"></i>+ 9850678910</li>
                                <li>
                                    <i class="fa fa-envelope-o" aria-hidden="true"></i>infonewsedge.com</li>
                                <li>
                                    <i class="fa fa-fax" aria-hidden="true"></i>+ 9850678910</li>
                            </ul>
                            <div class="topic-border color-cod-gray mb-30">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <input type="text" placeholder="Name" class="form-control" name="name" id="form-subject" data-error="Name field is required"
                                                    required="">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <input type="email" placeholder="Your E-mail" class="form-control" name="email" id="form-email" data-error="Email field is required"
                                                    required="">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
